...
# ntfy also emails a copy of each alert here (free, no SMTP setup needed).
ALERT_EMAIL = "andi@serafim.fr"
...
def send_push(title: str, message: str) -> None:
    """Push notification via ntfy.sh + email copy to ALERT_EMAIL.
    ...
    try:
        ...
        print(f"[info] ntfy response: {resp.status_code} (push + email to {ALERT_EMAIL})")
